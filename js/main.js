...
const i18n = {
  en: {
    ...
    'proj.aiframework': "Interactive decision tree for picking the right AI type for any project — ML, LLM, GenAI, Agentic, Embeddings, RAG, CV, and more. No vibes, no trends. Output shape and data type.",
  ...
  es: {
    ...
    'proj.aiframework': 'Árbol de decisión interactivo para elegir el tipo de IA correcto en cualquier proyecto — ML, LLM, GenAI, Agéntico, Embeddings, RAG, CV y más. Sin modas, sin tendencias. Forma de salida y tipo de datos.',
